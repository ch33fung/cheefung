...
<header class={'sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border border-solid' + (
    ...
    text-slate-950"> -->
      ...
      <h4 class="relative z-9"><a target='_blank' href="https:wa.me/60102226151">Get in Touch</h4> -->
        <!-- <h4 class="relative z-9"><a target='_blank' href="contactme">Get in Touch</h4> -->
    <!-- </a> -->
</header>