...
<main class='flex flex-col flex-1 p-4'>
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
      ...
      <p class='text-base sm:text-lg md:text-xl'>
        My <span class="text-violet-400">favourite tech</span> includes Javascript (Node.JS
        or SvelteKit), <br/>TailwindCSS, Express.JS & PostgreSQL!
      </p>
      ...
      <h4 class="relative z-9"><a target='_blank' href="https:wa.me/60102226151">Get in Touch &rarr;</a></h4>
      </a>
    </div>
